 ...
 * tokenizepascal.js. Note that your parsers do not have to be
 * this complicated -- if you don't want to recognize local variables,
 * in many languages it is enough to just look for braces, semicolons,
 * parentheses, etc, and know when you are inside a string or comment.
 *
 * See manual.html for more info about the parser interface.
 * Pascal highlighter by Farshad Mohajeri. farshad@fmsoft.net
 * adopted from CSharp highlighter  
 */
...
var JSParser = Editor.Parser = (function() {
  ...
  function pascalLexical(indented, column, type, align, prev, info) {
  ...
  // pascal indentation rules.
  function indentpascal(lexical) {
  ...
  function parsepascal(input, basecolumn) {
    // Wrap the input in a token stream
    var tokens = tokenizepascal(input);
    ...
    var lexical = new pascalLexical((basecolumn || 0) - indentUnit, 0, "block", false);
    ...
    function next(){
      ...
      if (token.content == "\n"){
        ...
        // them.
        token.indentation = indentpascal(lexical);
      }
    ...
    function copy(){
      ...
      return function copyParser(input){
        ...
        column = indented = 0;
        tokens = tokenizepascal(input, _tokenState);
        return parser;
      };
    }
    ...
    function pushlex(type, info) {
      var result = function(){
        lexical = new pascalLexical(indented, column, type, null, lexical, info)
      };
      result.lex = true;
      return result;
    }
    ...
    function property(type){
      if (type == "variable") {mark("pascal-property"); cont();}
    }
    // This parses a property and its value in an object literal.
    function objprop(type){
      if (type == "variable") mark("pascal-property");
